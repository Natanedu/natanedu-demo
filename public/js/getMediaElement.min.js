function getMediaElement(e, t) {
  ...
  if (
    !e.nodeName ||
    (e.nodeName.toLowerCase() != "audio" && e.nodeName.toLowerCase() != "video")
  ) {
    ...
    ] = !!navigator.mozGetUserMedia ? n : window.webkitURL.createObjectURL(n);
  }
  ...
  if (r.has("mute-audio")) {
    ...
    o.className =
      "control " +
      (t.toggle.has("mute-audio") ? "unmute-audio selected" : "mute-audio");
    s.appendChild(o);
    o.onclick = function() {
  ...
  if (r.has("mute-video")) {
    ...
    u.className =
      "control " +
      (t.toggle.has("mute-video") ? "unmute-video selected" : "mute-video");
    s.appendChild(u);
    u.onclick = function() {
  ...
  if (r.has("full-screen")) {
    ...
    v.className =
      "control " + (t.toggle.has("zoom-in") ? "zoom-out selected" : "zoom-in");
    if (!d && !c && !h && v) {
