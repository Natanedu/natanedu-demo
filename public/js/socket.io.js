...
(function(n, t) {
  ...
  (i.version = "0.9.0"),
    ...
    (i.connect = function(n, r) {
      ...
      return (
        t &&
          t.location &&
          ((u.protocol = u.protocol || t.location.protocol.slice(0, -1)),
          (u.host =
            u.host || (t.document ? t.document.domain : t.location.hostname)),
          (u.port = u.port || t.location.port)),
  ...
  (function(n, t) {
    ...
    (i.parseUri = function(n) {
      ...
      (i.chunkQuery = function(n) {
        for (var u = {}, r = n.split("&"), i = 0, f = r.length, t; i < f; ++i)
          (t = r[i].split("=")), t[0] && (u[t[0]] = t[1]);
        return u;
      }),
      (r = !1),
      (i.load = function(n) {
        if (("document" in t && document.readyState === "complete") || r)
          return n();
        i.on(t, "load", n, !1);
      }),
      (i.on = function(n, t, i, r) {
        n.attachEvent
          ...
          : n.addEventListener && n.addEventListener(t, i, r);
      }),
      (i.request = function(n) {
        if (n && "undefined" != typeof XDomainRequest)
          return new XDomainRequest();
        if ("undefined" != typeof XMLHttpRequest && (!n || i.ua.hasCORS))
      ...
      (i.intersect = function(n, t) {
        for (
          var f = [],
            ...
            u = n.length > t.length ? t : n,
            r = 0,
            e = u.length;
          r < e;
          r++
        )
          ~i.indexOf(o, u[r]) && f.push(u[r]);
        return f;
      }),
      (i.indexOf = function(n, t, i) {
        for (
          var r = n.length, i = i < 0 ? (i + r < 0 ? 0 : i + r) : i || 0;
          i < r && n[i] !== t;
          i++
        );
        return r <= i ? -1 : i;
    ...
    (n.EventEmitter = i),
      (i.prototype.on = function(n, i) {
        return (
          ...
          this.$events[n]
            ? t.util.isArray(this.$events[n])
              ? this.$events[n].push(i)
              : (this.$events[n] = [this.$events[n], i])
            : (this.$events[n] = i),
          this
        );
      }),
      ...
      (i.prototype.removeAllListeners = function(n) {
        return (
          this.$events && this.$events[n] && (this.$events[n] = null), this
        );
      }),
      ...
      (i.prototype.emit = function(n) {
        ...
        if ("function" == typeof i) i.apply(this, f);
          ...
          for (u = i.slice(), r = 0, e = u.length; r < e; r++)
            u[r].apply(this, f);
        else return !1;
        return !0;
      });
  ...
  (function(n, t) {
    ...
    var o;
    if (t && t.parse)
      return (n.JSON = { parse: t.parse, stringify: t.stringify });
    o = n.JSON = {};
    var c = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
    ...
    (i.encodePacket = function(n) {
      ...
      switch (n.type) {
        ...
        case "ack":
          t =
            n.ackId +
            (n.args && n.args.length ? "+" + r.stringify(n.args) : "");
      }
      return (
        (c = [l, y + (a == "data" ? "+" : ""), v]),
      ...
      (i.decodePayload = function(n) {
        var u, t, r;
        if (n.charAt(0) == "\ufffd") {
          for (u = [], t = 1, r = ""; t < n.length; t++)
            n.charAt(t) == "\ufffd"
              ? (u.push(i.decodePacket(n.substr(t + 1).substr(0, r))),
                (t += Number(r) + 1),
                (r = ""))
              : (r += n.charAt(t));
          return u;
  ...
  (function(n, t, i) {
    ...
    (n.Socket = r),
      ...
      (r.prototype.of = function(n) {
        return (
          this.namespaces[n] ||
            ((this.namespaces[n] = new t.SocketNamespace(this, n)),
            n !== "" && this.namespaces[n].packet({ type: "connect" })),
          this.namespaces[n]
        );
      }),
      (r.prototype.publish = function() {
        ...
        for (n in this.namespaces)
          this.namespaces.hasOwnProperty(n) &&
            ((t = this.of(n)), t.$emit.apply(t, arguments));
      }),
          ...
          : ((i = t.util.request()),
            ...
            (i.onreadystatechange = function() {
              i.readyState == 4 &&
                ...
                i.status == 200
                  ? s(i.responseText)
                  : !o.reconnecting && o.onError(i.responseText));
            }),
            i.send(null));
      }),
      (r.prototype.getTransport = function(n) {
        for (var u = n || this.transports, f, i, r = 0; (i = u[r]); r++)
          if (
            t.Transport[i] &&
            t.Transport[i].check(this) &&
            (!this.isXDomain() || t.Transport[i].xdomainCheck())
          )
            return new t.Transport[i](this, this.sessionid);
        return null;
      }),
      (r.prototype.connect = function(n) {
        ...
        var i = this;
        return (
          this.handshake(function(r, u, f, e) {
            function o(n) {
                    ...
                    (i.connectTimeoutTimer = setTimeout(function() {
                      if (!i.connected) {
                        ...
                        if (i.options["try multiple transports"]) {
                          i.remainingTransports ||
                            (i.remainingTransports = i.transports.slice(0));
                          var n = i.remainingTransports;
                          while (
                            n.length > 0 &&
                            n.splice(0, 1)[0] != i.transport.name
                          );
            ...
            (i.sessionid = r),
              ...
              (i.transports = t.util.intersect(
                e.split(","),
                i.options.transports
              )),
              o();
      ...
      (r.prototype.isXDomain = function() {
        ...
        return (
          this.options.host !== i.location.hostname || this.options.port != n
        );
      }),
      ...
      (r.prototype.reconnect = function() {
        function i() {
          if (n.connected) {
            for (var i in n.namespaces)
              n.namespaces.hasOwnProperty(i) &&
                "" !== i &&
                n.namespaces[i].packet({ type: "connect" });
        ...
        function t() {
          ...
          if (n.connecting && n.reconnecting)
            return (n.reconnectionTimer = setTimeout(t, 1e3));
          if (n.reconnectionAttempts++ < u)
            n.reconnectionDelay < f && (n.reconnectionDelay *= 2),
              n.connect(),
              n.publish(
                "reconnecting",
                n.reconnectionDelay,
  ...
  (function(n, t) {
    ...
    (n.SocketNamespace = i),
      ...
      (i.prototype.send = function(n, t) {
        ...
        return (
          "function" == typeof t &&
            ((i.id = ++this.ackPackets), (i.ack = !0), (this.acks[i.id] = t)),
          this.packet(i)
        );
      }),
      (i.prototype.emit = function(n) {
      ...
      (i.prototype.onPacket = function(n) {
        ...
        switch (n.type) {
          ...
          case "disconnect":
            if (this.name === "")
              this.socket.onDisconnect(n.reason || "booted");
          ...
          case "json":
            (i = ["message", n.data]),
              n.ack == "data"
                ? i.push(r)
                : n.ack && this.packet({ type: "ack", ackId: n.id }),
          ...
          case "ack":
            this.acks[n.ackId] &&
              (this.acks[n.ackId].apply(this, n.args),
              delete this.acks[n.ackId]);
            break;
          case "error":
            if (n.advice) this.socket.onError(n);
            else
              n.reason == "unauthorized"
                ? this.$emit("connect_failed", n.reason)
                : this.$emit("error", n.reason);
        }
      }),
    ...
    (n.websocket = r),
      ...
      (r.prototype.open = function() {
        var u = t.util.query(this.socket.options.query),
          ...
          r;
        return (
          r || (r = i.MozWebSocket || i.WebSocket),
      ...
      (r.check = function() {
        return (
          ("WebSocket" in i && !("__addTask" in WebSocket)) ||
          "MozWebSocket" in i
        );
      }),
        ...
        function u() {
          var t = n.options,
            ...
            e = [
              ...
              t.resource,
              "static/flashsocket",
              "WebSocketMain" + (n.isXDomain() ? "Insecure" : "") + ".swf"
            ];
          i.loaded ||
            (typeof WEB_SOCKET_SWF_LOCATION == "undefined" &&
              (WEB_SOCKET_SWF_LOCATION = e.join("/")),
            u !== 843 &&
              WebSocket.loadFlashPolicyFile("xmlsocket://" + t.host + ":" + u),
  ...
  var swfobject = (function() {
                ...
                if (h[r].expressInstall && tt()) {
                  (e = {}),
                    ...
                    t.getAttribute("class") &&
                      (e.styleclass = t.getAttribute("class")),
                    t.getAttribute("align") &&
                      (e.align = t.getAttribute("align"));
                  var p = {},
                    a = t.getElementsByTagName("param"),
                    w = a.length;
                  for (c = 0; c < w; c++)
                    a[c].getAttribute("name").toLowerCase() != "movie" &&
                      (p[a[c].getAttribute("name")] = a[c].getAttribute(
                        "value"
                      ));
                  et(e, p, o, s);
                } else ui(t), s && s(f);
    ...
    function it(n) {
      ...
      return (
        t &&
          t.nodeName == "OBJECT" &&
          (typeof t.SetVariable != i
            ? (e = t)
            : ((r = t.getElementsByTagName(f)[0]), r && (e = r))),
        e
      );
    }
    function tt() {
        ...
        if (u) {
          ...
          if (i)
            for (o = i.length, r = 0; r < o; r++)
              (i[r].nodeType == 1 && i[r].nodeName == "PARAM") ||
                i[r].nodeType == 8 ||
                e.appendChild(i[r].cloneNode(!0));
        }
      }
      return e;
    }
    function rt(t, r, e) {
      ...
      if (w) {
        ...
        if (n.ie && n.win) {
          y = "";
          for (o in t)
            t[o] != Object.prototype[o] &&
              (o.toLowerCase() == "data"
                ? (r.movie = t[o])
                : o.toLowerCase() == "styleclass"
                ? (y += ' class="' + t[o] + '"')
                : o.toLowerCase() != "classid" &&
                  (y += " " + o + '="' + t[o] + '"'));
          b = "";
          for (a in r)
            r[a] != Object.prototype[a] &&
              (b += '<param name="' + a + '" value="' + r[a] + '" />');
          (w.outerHTML =
          ...
          for (h in t)
            t[h] != Object.prototype[h] &&
              (h.toLowerCase() == "styleclass"
                ? c.setAttribute("class", t[h])
                : h.toLowerCase() != "classid" && c.setAttribute(h, t[h]));
          for (l in r)
            r[l] != Object.prototype[l] &&
              l.toLowerCase() != "movie" &&
              ri(c, l, r[l]);
    ...
    function wt(r, u, o, h) {
      ...
      (l = o && typeof o == "string" ? o : "screen"),
        ...
        (e && ot == l) ||
          ...
          c.setAttribute("media", l),
          (e = a.appendChild(c)),
          n.ie &&
            n.win &&
            typeof t.styleSheets != i &&
            t.styleSheets.length > 0 &&
            (e = t.styleSheets[t.styleSheets.length - 1]),
          (ot = l)),
        n.ie && n.win
          ? e && typeof e.addRule == f && e.addRule(r, u)
          : e &&
            typeof t.createTextNode != i &&
            e.appendChild(t.createTextNode(r + " {" + u + "}"));
    }
    function l(n, t) {
      if (!bt) return;
    ...
    var i = "undefined",
      ...
      n = (function() {
        var a =
          ...
          v = /webkit/.test(s)
            ? parseFloat(s.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1"))
            : !1,
          h = !1,
          u = [0, 0, 0],
          n = null,
          c;
        if (typeof o.plugins != i && typeof o.plugins[at] == f)
          (n = o.plugins[at].description),
            !n ||
              (typeof o.mimeTypes != i &&
                o.mimeTypes[p] &&
                !o.mimeTypes[p].enabledPlugin) ||
              ((vt = !0),
              (h = !1),
              ...
              (u[2] = /[a-zA-Z]/.test(n)
                ? parseInt(n.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10)
                : 0));
      ...
      ei = (function() {
        if (!n.w3) return;
        ((typeof t.readyState != i && t.readyState == "complete") ||
          (typeof t.readyState == i &&
            (t.getElementsByTagName("body")[0] || t.body))) &&
          v(),
          c ||
            (typeof t.addEventListener != i &&
              t.addEventListener("DOMContentLoaded", v, !1),
            n.ie &&
              n.win &&
              (t.attachEvent(yt, function() {
                t.readyState == "complete" &&
                  (t.detachEvent(yt, arguments.callee), v());
              }),
              r == top &&
                (function() {
                  if (c) return;
        ...
        n.ie &&
          ...
          window.attachEvent("onunload", function() {
            for (var e = a.length, u, i, r, f, t = 0; t < e; t++)
      ...
      getQueryParamValue: function(n) {
        ...
        if (r) {
          ...
          for (u = r.split("&"), i = 0; i < u.length; i++)
            if (u[i].substring(0, u[i].indexOf("=")) == n)
              return st(u[i].substring(u[i].indexOf("=") + 1));
        }
        return "";
      },
      expressInstallCallback: function() {
        if (w) {
          ...
          t &&
            ...
            d && (l(d, !0), n.ie && n.win && (y.style.display = "block")),
            ut && ut(ct)),
            (w = !1);
        }
      }
...
(function() {
  ...
  (n && n.log && n.error) || (n = { log: function() {}, error: function() {} });
  ...
  location.protocol == "file:" &&
    ...
    (WebSocket.prototype.dispatchEvent = function(n) {
      for (var r = this.__events[n.type] || [], i, t = 0; t < r.length; ++t)
        r[t](n);
      (i = this["on" + n.type]), i && i(n);
    }),
    (WebSocket.prototype.__handleEvent = function(n) {
      var t, i;
      "readyState" in n && (this.readyState = n.readyState),
        "protocol" in n && (this.protocol = n.protocol);
      if (n.type == "open" || n.type == "error")
        t = this.__createSimpleEvent(n.type);
      else if (n.type == "close") t = this.__createSimpleEvent("close");
      else if (n.type == "message")
        (i = decodeURIComponent(n.message)),
    ...
    (WebSocket.prototype.__createMessageEvent = function(n, t) {
      if (document.createEvent && window.MessageEvent && !window.opera) {
        ...
        return (
          i.initMessageEvent("message", !1, !1, t, null, null, window, null), i
        );
      }
    ...
    (WebSocket.loadFlashPolicyFile = function(n) {
      WebSocket.__addTask(function() {
    ...
    (WebSocket.__onFlashInitialized = function() {
      setTimeout(function() {
        ...
        for (var n = 0; n < WebSocket.__tasks.length; ++n)
          WebSocket.__tasks[n]();
        WebSocket.__tasks = [];
      }, 0);
    }),
    (WebSocket.__onFlashEvent = function() {
      return (
        setTimeout(function() {
          ...
          try {
            for (
              i = WebSocket.__flash.receiveEvents(), t = 0;
              t < i.length;
              ++t
            )
              WebSocket.__instances[i[t].webSocketId].__handleEvent(i[t]);
          } catch (r) {
            n.error(r);
          }
        }, 0),
    ...
    (WebSocket.__isFlashLite = function() {
      ...
      return !n || !n.enabledPlugin || !n.enabledPlugin.filename
        ? !1
        : n.enabledPlugin.filename.match(/flashlite/i)
        ? !0
        : !1;
    }),
    ...
    (n.XHR = r),
      ...
      (r.prototype.payload = function(n) {
        for (var u = [], i = 0, r = n.length; i < r; i++)
          u.push(t.parser.encodePacket(n[i]));
      ...
      (r.prototype.post = function(n) {
        ...
        this.socket.setBuffer(!0),
          ...
          i.XDomainRequest && this.sendXHR instanceof XDomainRequest
            ? (this.sendXHR.onload = this.sendXHR.onerror = r)
            : (this.sendXHR.onreadystatechange = f),
          this.sendXHR.send(n);
      }),
      (r.prototype.close = function() {
  ...
  (function(n, t) {
    ...
    (n.htmlfile = i),
      t.util.inherit(i, t.Transport.XHR),
    ...
    (n["xhr-polling"] = r),
      ...
      (r.prototype.get = function() {
        ...
        (this.xhr = this.request()),
          i.XDomainRequest && this.xhr instanceof XDomainRequest
            ? ((this.xhr.onload = r), (this.xhr.onerror = t))
    ...
    (n["jsonp-polling"] = r),
      ...
      (r.prototype.post = function(n) {
        ...
        (this.form.action = this.prepareUrl() + h),
          e(),
          (this.area.value = t.JSON.stringify(n));
        try {
          this.form.submit();
        } catch (c) {}
